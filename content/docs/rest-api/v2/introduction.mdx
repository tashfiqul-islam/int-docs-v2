...
<Accordions type="multiple">
  ...
  <Accordion title="Talent Management">
...
[Authentication guide →](/docs/rest-api/v2/authentication)
...
<Cards>
  <Card title="Quickstart" icon="Zap" href="/docs/rest-api/v2/quickstart">
    Create your first work order in 5 minutes
  </Card>
  <Card title="Authentication" icon="Lock" href="/docs/rest-api/v2/authentication">
    OAuth 2.0 setup and token management
  </Card>
  <Card title="Common Patterns" icon="Code" href="/docs/rest-api/v2/common-patterns">
    Frequently used workflows and examples
  </Card>
  <Card title="Support" icon="CircleQuestionMark" href="/docs/resources/support">
