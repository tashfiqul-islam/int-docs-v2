...
<Cards>
  <Card title="Quickstart" icon="Zap" href="/docs/rest-api/quickstart">
    Create your first work order in 5 minutes
  </Card>
  <Card title="Authentication" icon="Lock" href="/docs/rest-api/authentication">
    OAuth 2.0 setup and token management
  </Card>
  <Card title="Common Patterns" icon="Code" href="/docs/rest-api/common-patterns">
