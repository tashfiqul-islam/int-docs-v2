...
<Callout type="info">
**Save the `access_token`** - You'll use it in subsequent requests. Tokens typically expire after 1 hour.
</Callout>
...
<Callout type="info">
**Work Order Created!** The work order is in "Draft" status. Save the `id` (12345 in this example) for next steps.
</Callout>
