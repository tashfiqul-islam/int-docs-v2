...
<TypeTable
  type={{
    ...
    "client_id": {
      type: "string",
      description: "Your API client ID provided by Field Nation",
      required: true
    },
    "client_secret": {
      type: "string",
      description: "Your API client secret provided by Field Nation",
      required: true
    },
    "scope": {
      type: "string",
      description: "API scope. Use `api` for full REST API access",
      required: true
    }
  }}
/>
...
<TypeTable
  type={{
    "access_token": {
      type: "string",
      description: "JWT access token to use in API requests"
    },
    "token_type": {
      type: "string",
