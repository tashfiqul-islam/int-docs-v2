...
<Callout type="info">
  While 33 events cover core workflows, we're continuously expanding event coverage. Check the [Webhooks Events Catalog](/docs/webhooks/v3/concepts/events) for the complete list.
</Callout>
...
3. Set up [Webhooks](/docs/webhooks/v3/quickstart)
4. Explore [REST API Introduction](/docs/rest-api/v2/introduction) for all capabilities
