...
<Cards>
  <Card title="REST API" href="/docs/rest-api/v2/introduction" icon="💻">
    Programmatic access to Field Nation platform via REST API
  </Card>
  <Card title="Webhooks" href="/docs/webhooks/v3/introduction" icon="🔔">
    Real-time event notifications via Platform Event Streams
  </Card>
  <Card title="Connectors" href="/docs/connectors/introduction" icon="🔌">
    Pre-built integrations for popular ERP and CRM platforms
  </Card>
  <Card title="Resources" href="/docs/resources/glossary" icon="📚">
...
<Accordions type="single">
  <Accordion title="Comprehensive API Coverage">
  ...
  <Accordion title="Real-time Event Streams">
  ...
  <Accordion title="Out-of-the-box Connectors">
