...
<TypeTable
  type={{
    ...
    "sortBy": {
      type: "string",
      description: "Sort by: deliveryId, webhookId, workOrderId, eventName, deliveryStatus, createdAt",
      required: false,
      default: "createdAt"
    },
    "sortDirection": {
...
<Tabs items={["All Logs", "Failed Deliveries", "By Webhook", "By Work Order"]}>
  <Tab value="All Logs">
    ```bash
...
![Retry Delivery](../images/delivery-log-retry.png)
