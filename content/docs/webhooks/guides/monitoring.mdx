...
<TypeTable
  type={{
    "delivery_success_rate": {
      type: "percentage",
      description: "Percentage of successful deliveries (2xx responses). Target: >99%",
      required: true
    },
    "delivery_latency": {
      type: "duration (ms)",
      description: "Time from event trigger to successful delivery. Target: <5s p95",
      required: true
    },
    "retry_rate": {
      type: "percentage",
      description: "Percentage of deliveries requiring retries. Target: <5%",
      required: true
    },
    "timeout_rate": {
      type: "percentage",
      description: "Percentage of deliveries that timeout. Target: <1%",
      required: true
    }
  }}
/>
...
<TypeTable
  type={{
    "processing_duration": {
      type: "duration (ms)",
      description: "Time to process webhook payload. Target: <2s p95",
      required: true
    },
    "queue_depth": {
      type: "count",
      description: "Number of webhooks waiting to be processed. Target: <100",
      required: true
    },
    "processing_errors": {
      type: "count",
      description: "Number of processing failures. Target: <10/hour",
      required: true
    },
    "dlq_size": {
      type: "count",
      description: "Number of events in dead letter queue. Target: 0",
      required: true
    }
  }}
/>
...
<TypeTable
  type={{
    "events_per_minute": {
      type: "rate",
      description: "Volume of webhook events received. Monitor for anomalies",
      required: false
    },
    "events_by_type": {
      type: "distribution",
      description: "Breakdown by event name. Identify patterns",
      required: false
    },
    "unique_work_orders": {
      type: "count",
      description: "Distinct work orders receiving events. Track coverage",
      required: false
    }
  }}
/>
...
<Tabs items={["Success Rate", "Latency", "Error Rate", "Queue Depth"]}>
  <Tab value="Success Rate">
    ```
...
<Tabs items={["Success Rate", "High Retry Rate", "Queue Buildup", "Processing Errors"]}>
  <Tab value="Success Rate">
    ```yaml
