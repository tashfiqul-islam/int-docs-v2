...
<Callout type="info">
**Full Schema**: The complete work order schema includes 100+ fields. Refer to the [REST API documentation](/docs/rest-api/introduction) for the full specification.
</Callout>
