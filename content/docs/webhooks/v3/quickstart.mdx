...
<Tabs items={["Request Inspector (Fastest)", "ngrok (Local Development)", "Production Server"]}>
  <Tab value="Request Inspector (Fastest)">
  ...
  <Tab value="ngrok (Local Development)">
...
<Tabs items={["Web UI (Easier)", "REST API (Programmatic)"]}>
  <Tab value="Web UI (Easier)">
  ...
  <Tab value="REST API (Programmatic)">
...
<Accordions type="multiple">
  ...
  <Accordion title="Check delivery logs">
  ...
  <Accordion title="Review event subscription">
