...
<Cards>
  ...
  <Card title="Standard Mappings" icon="GitBranch">
...
<Accordions type="multiple">
  <Accordion title="Your System Isn't Supported">
  ...
  <Accordion title="You Have an OpenAPI Spec">
  ...
  <Accordion title="Basic CRUD Operations Sufficient">
  ...
  <Accordion title="Configuration-Driven Preferred">
...
<TypeTable
  type={{
    "Complex Workflows": {
      type: "Limitation",
      description: "Multi-step processes, conditional branching, complex state machines"
    },
    "Advanced Transformations": {
      type: "Limitation",
      description: "Complex business logic beyond standard field mappings and JSONNET"
    },
    "Custom Protocols": {
      type: "Limitation",
      description: "Non-REST APIs, SOAP (unless REST wrapper available), GraphQL (direct)"
    },
    "Authentication Methods": {
      type: "Limitation",
      description: "Only Basic Auth supported (OAuth, API keys, custom auth headers require REST API integration)"
    },
    "All API Features": {
      type: "Limitation",
      description: "Built for one buyer's requirements - may need enhancement for additional functionality"
    }
  }}
/>

<Callout type="info">
**Extensibility**: The REST Connector was built for specific use cases and can be extended with additional functionality as needed. Contact [Field Nation Support](https://app.fieldnation.com/support-cases) to discuss feature requirements.
</Callout>
...
<Accordions type="multiple">
  ...
  <Accordion title="Basic Authentication Support">
