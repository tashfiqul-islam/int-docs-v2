...
<TypeTable
  type={{
    "Work Order Creation": {
      type: "Inbound",
      description: "Create FN work order from Autotask Ticket via webhook"
    },
    "Work Order Update": {
      type: "Inbound",
      description: "Update existing FN work order when Autotask Ticket changes"
    },
    "Status Synchronization": {
      type: "Outbound",
      description: "Update Autotask Ticket when FN work order status changes"
    },
    "Notes Sync": {
      type: "Bidirectional",
      description: "Sync comments via Ticket Notes"
    }
  }}
/>
...
<Accordions type="multiple">
  ...
  <Accordion title="API Integration Token">
