...
<TypeTable
  type={{
    "Active Buyer Account": {
      type: "Required",
      description: "You must have an active buyer account in Field Nation. Only buyers have access to integration features.",
      required: true
    },
    "Admin Access": {
      type: "Required",
      description: "Administrative access to Field Nation's integration settings to configure connectors.",
      required: true
    },
    "Company ID": {
      type: "Required",
      description: "Your Field Nation Company ID (found in Company Settings > Company Profile).",
      required: true
    },
    "Sandbox Access": {
      type: "Recommended",
...
<Accordions type="multiple">
  <Accordion title="Admin Access to External Platform">
  ...
  <Accordion title="Object & Field Access">
...
<Callout type="info">
**First Time Setup**: If you don't see the Integrations section, contact [Field Nation Support](https://app.fieldnation.com/support-cases) to enable connector access for your account.
</Callout>
...
<TypeTable
  type={{
    "Source Field": {
      type: "string",
      description: "The field from the originating system (e.g., external system field name or Field Nation field name)",
      required: true
    },
    "Target Field": {
      type: "string",
      description: "The field in the destination system where data will be written",
      required: true
    },
    "Transformation Action": {
      type: "enum",
      description: "How to transform the data: Sync (direct copy), Set Static, Array Map, Range Map, Date Convert, Concat, Custom JSONNET",
      required: true
    },
    "Default Value": {
      type: "any",
      description: "Value to use if source field is empty or null",
      required: false
    }
  }}
/>
...
<Tabs items={["Basic Auth", "OAuth 2.0", "API Keys", "SOAP/Token"]}>
...
<Accordions type="multiple">
  ...
  <Accordion title="Incorrect Field Types">
  ...
  <Accordion title="Authentication Expiration">
