...
<Tabs items={["Getting Started", "Integration Options", "Webhooks & API", "Connectors", "Support"]}>
...
[Explore Webhooks →](/docs/webhooks/v3/introduction)
...
[Payload Structure →](/docs/webhooks/v3/concepts/payload-structure)
...
[Troubleshooting Guide →](/docs/webhooks/v3/troubleshooting/common-issues)
...
**Webhooks:**
- [Introduction](/docs/webhooks/v3/introduction) - Overview and features
- [Quickstart](/docs/webhooks/v3/quickstart) - 15-minute setup guide
- [API Reference](/docs/webhooks/v3/api-reference/overview) - Complete API documentation
...
<Cards>
  ...
  <Card title="Glossary" icon="BookOpen" href="/docs/resources/glossary">
    Understand platform terminology
  </Card>
  <Card title="Error Codes" icon="CircleAlert" href="/docs/resources/error-codes">
    Common errors and solutions
  </Card>
  <Card title="Status Page" icon="Activity" href="https://status.fieldnation.com">
    Check system status
  </Card>
</Cards>
