...
<TypeTable
  type={{
    "Web Application": {
      type: "URL",
      description: "[app-sandbox.fndev.net](https://app-sandbox.fndev.net)",
      required: false
    },
    "API Base URL": {
      type: "URL",
      description: "[api-sandbox.fndev.net](https://api-sandbox.fndev.net)",
      required: false
    },
    "Webhooks UI": {
      type: "URL",
      description: "[ui-sandbox.fndev.net/integrations/webhooks](https://ui-sandbox.fndev.net/integrations/webhooks)",
      required: false
    },
    "Swagger UI": {
      type: "URL",
      description: "[ui-sandbox.fndev.net/integrations/webhooks/_api](https://ui-sandbox.fndev.net/integrations/webhooks/_api)",
      required: false
    }
  }}
/>
...
<Callout type="info">
**Access Required**: Request sandbox access through a [support case](https://app.fieldnation.com/support-cases) with your Company ID and integration requirements.
</Callout>
...
<TypeTable
  type={{
    "Web Application": {
      type: "URL",
      description: "[app.fieldnation.com](https://app.fieldnation.com)",
      required: false
    },
    "API Base URL": {
      type: "URL",
      description: "Contact Field Nation support for production access",
      required: false
    },
    "Status Page": {
      type: "URL",
      description: "[status.fieldnation.com](https://status.fieldnation.com)",
      required: false
    }
  }}
/>
...
<Tabs items={["Deployment Steps", "Monitoring", "Rollback Plan"]}>

<Tab value="Deployment Steps">
